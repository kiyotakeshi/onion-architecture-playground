...
public class TaskRestController {
    ...
    public TaskRestController(GetTaskUsecase getTaskUsecase, GetTasksUsecase getTasksUsecase, CreateTaskUsecase createTaskUsecase, UpdateTaskUsecase updateTaskUsecase, DeleteTaskUsecase deleteTaskUsecase) {
    ...
    public ResponseEntity<TaskResponseDto> getTask(@PathVariable Integer id){
        ...
        var taskResponseDto = new TaskResponseDto(taskEntity.getId(), taskEntity.getName(), taskEntity.getDueDate(), taskEntity.getTaskStatus());
    ...
    @PutMapping("/{id}")
    public ResponseEntity<TaskResponseDto> updateTask(@PathVariable Integer id, @RequestBody TaskUpdateRequestDto taskUpdateRequestDto){
        TaskEntity taskEntity = updateTaskUsecase.updateTask(id, taskUpdateRequestDto.getName(), taskUpdateRequestDto.getDueDate(), taskUpdateRequestDto.getTaskStatus());
        var taskResponseDto = new TaskResponseDto(taskEntity.getId(), taskEntity.getName(), taskEntity.getDueDate(), taskEntity.getTaskStatus());
        return ResponseEntity.ok(taskResponseDto);
    }
